...
!----------------------------------------------------------------------|
      ...
      implicit none 
      integer*8 ideg, m, ldh, lwsp, iexph, ns, iflag, ipiv(m) 
...
!----------------------------------------------------------------------|
!                                                                       
      integer*8 mm,i,j,k,ih2,ip,iq,iused,ifree,iodd,icoef,iput,iget 
...
!----------------------------------------------------------------------|
      ...
      double precision t 
      integer*8          ideg, m, ldh, lwsp, iexph, ns, iflag, ipiv(m) 
      double complex       H(ldh,m), wsp(lwsp) 
...
!----------------------------------------------------------------------|
!                                                                       
      integer*8 i,j,k,icoef,mm,ih2,iodd,iused,ifree,iq,ip,iput,iget 
      double precision hnorm 
      double complex cp, cq, scale, scale2, ZERO, ONE 
...
!----------------------------------------------------------------------|
!                                                                       
      integer*8 ndeg, i, j, ip, ih, iy, iz 
      parameter ( ndeg=7 ) 
      double precision alpha0 
      double complex alpha(ndeg), theta(ndeg) 
...
!                                                                       
      ...
      parameter ( ndeg=7 ) 
      double precision alpha0 
      double complex alpha(ndeg), theta(ndeg), w 
...
!----------------------------------------------------------------------|
      ...
      integer*8          m, ldh, iflag, iwsp(m) 
      double precision t 
      double complex       H(ldh,m), y(m), wsp(m*(m+2)) 
...
!                                                                       
      ...
      parameter ( ndeg=7 ) 
      double      precision alpha0 
      double complex  alpha(2*ndeg), theta(2*ndeg) 
...
!                                                                       
      double complex ZERO 
      integer*8 ndeg, i, j, k, ip, ih, iy, iz 
...
!----------------------------------------------------------------------|
      subroutine ZGEXPV(n,Ngrid_r,lmin,lmax,L_Coupling,m,t,v,w,tol,anorm,&
                         &wsp,lwsp,iwsp,liwsp,matvec,itrace,iflag,&
                         &H_DIAG,H_DIAG1,H_DIAG2,H_NONDIAG,H_LASER,&
                         &H_LASER1,H_LASER2)   
                                                                        
      implicit none
      integer*8          n,Ngrid_r,lmin,lmax,L_Coupling,m,lwsp,liwsp
      integer*8          itrace,iflag,iwsp(liwsp)
      double precision t, tol, anorm,H_DIAG1,H_DIAG2
      double precision H_DIAG(Ngrid_r,0:lmax),H_LASER(Ngrid_r,0:lmax)
      double precision H_NONDIAG(Ngrid_r,0:lmax,0:lmax)
      double precision H_LASER1(0:lmax),H_LASER2(0:lmax)
      double complex       v(n), w(n), wsp(lwsp)
      external         matvec
...
!                                                                       
      integer*8 mxstep, mxreject, ideg 
...
!----------------------------------------------------------------------|
      ...
      parameter( ZERO=(0.0d0,0.0d0), ONE=(1.0d0,0.0d0) ) 
      integer*8 i, j, k1, mh, mx, iv, ih, j1v, ns, ifree, lfree, iexph,   &
...
!                                                                       
      ...
      do 200 j = 1,m 
         nmult = nmult + 1 
         call matvec(wsp(j1v-n),wsp(j1v),n,Ngrid_r,lmin,lmax,L_Coupling,&
              &H_DIAG,H_DIAG1,H_DIAG2,H_NONDIAG,H_LASER,H_LASER1,H_LASER2) 
         do i = 1,j 
...
!----------------------------------------------------------------------|
!----------------------------------------------------------------------|
      subroutine ZHEXPV(n,Ngrid_r,lmax,m,t,v,w,tol,anorm,&
                         &wsp,lwsp,iwsp,liwsp,matvec,itrace,iflag,A)   
                                                                        
      implicit none
      integer*8          n,Ngrid_r,lmax,m,lwsp,liwsp,itrace,iflag,iwsp(liwsp)
...
!                                                                       
      ...
      do 200 j = 1,m 
         nmult = nmult + 1 
         call matvec(wsp(j1v-n),wsp(j1v),n,Ngrid_r,lmax,A)
         if ( j.gt.1 )                                                  &
